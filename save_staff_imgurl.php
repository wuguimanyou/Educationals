...
$destination_folder="up/staff/"; //上传文件路径
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	//是否存在文件
	{
	   if($keyid<=0){
	       ...
	       $destination = $_POST["staff_imgurl"];
	   }
	}else{
		$file = $_FILES["upfile"];
 ...
 echo "<script>location.href='iframe_images_staff.php?customer_id=".$customer_id_en."&staff_imgurl=".$destination."';</script>";
 }
?>
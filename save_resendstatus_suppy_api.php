...
$supplier_id=$_SESSION['supplier_Acount'];   //供应商id
...
if(!is_numeric($batchcode) or $batchcode<0){
	...
	$query="select pid,sendstatus,paystyle,totalprice,prvalues,rcount from weixin_commonshop_orders where isvalid=true and batchcode='".$batchcode."' and supply_id=".$supplier_id." limit 0,1"; 

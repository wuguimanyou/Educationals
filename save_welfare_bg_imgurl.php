...
$destination_folder="up/welfare/"; //上传文件路径
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	//是否存在文件
	{
	   if($keyid<=0){
	       ...
	       $destination = $_POST["welfare_images"];
	   }
	}else{
		$file = $_FILES["upfile"];
 ...
 echo "<script>location.href='iframe_images_welfare.php?customer_id=".$customer_id_en."&welfare_images=".$destination."';</script>";
 }
?>
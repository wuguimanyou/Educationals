...
//$customer_id = $configutil->splash_new($_GET["customer_id"]); //前面的文件中已获取
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
		  ...
		  if($type_id_1_1>0){
			...
			if($linktype==1){
				 ...
				 if($product_detail_id_1_1>0){
					 ...
					 $url="detail.php?customer_id=".$customer_id."&pid=".$product_detail_id_1_1;
			...
			if($linktype==1){
				$product_detail_id_1_4 = $configutil->splash_new($_POST["product_detail_id_1_4"]);        
				 if($product_detail_id_1_4>0){
					 ...
					 $url="detail.php?customer_id=".$customer_id."&pid=".$product_detail_id_1_4;
 ...
 echo "<script>location.href='defaultset9.php?customer_id=".$customer_id_en."';</script>";
 }
?>